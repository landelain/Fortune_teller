...
function quit_choice (event) { //
    ...
    const quitmess = document.createElement('i')
    const fortune_teller = document.createElement('div')
    ...
    setTimeout(() => { document.body.appendChild(fortune_teller)    }, 1600);

    setTimeout(() => { document.querySelector('#fortune_teller').addEventListener('click', choice) }, 1700);
